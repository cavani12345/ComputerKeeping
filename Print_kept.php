...
<br />
<form action="Print_kept.php" method="post" name="Myform" style="display:block; text-align:right; margin-right:140px; margin-top:20px;" onsubmit="return validate();">
...
{
var printthis=document.getElementById('printsearch').innerHTML;
...
<button onclick="window.printDiv('printsearch')" style="padding:5px 20px;">Print Now</button><br /><br /><br />
<div id="printsearch">
<div align="center">
<script>
var today=new Date();
...
<h2><center><u>REPORT OF KEPT COMPUTERS</u></center></h2>
<table align="center" cellspacing="2" cellpadding="7" >
<tr bgcolor="#6699FF"><th>COMPUTER</th><th colspan="2">OWNER AND REG NUMBER</th><th>KEEPER</th><th>DATE</th></tr>
<?php
...
<td align="left"><?php echo $Owner_Fname." ".$Owner_Lname; ?>
</td>
<td>
...
function printDiv(printthis)
{
var printthis=document.getElementById('printall').innerHTML;
var wholedocument=document.body.innerHTML;
document.body.innerHTML=printthis;
window.print();
document.body.innerHTML=wholedocument;
...
<button onclick="window.printDiv('printall')" style="padding:5px 20px;">Print Now</button><br /><br /><br />
<div id="printall">
<div align="center">
<script>
var today=new Date();
